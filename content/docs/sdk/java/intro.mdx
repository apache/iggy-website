...
The snippets below follow the [getting-started example](https://github.com/apache/iggy/tree/master/examples/java/src/main/java/org/apache/iggy/examples/gettingstarted). Note that stream, topic, and partition IDs are **0-based**: the first partition of a topic is partition `0`.
