...
| **Connectors** | [Source & sink plugins](/docs/connectors/introduction) for PostgreSQL, MongoDB, Elasticsearch, Apache Iceberg, Quickwit with data transforms |
...
| **Clustering** | [Viewstamped Replication (VSR)](/docs/clustering/vsr) consensus protocol (in development) |
...
- **[Connectors Runtime](/docs/connectors/introduction)** - dynamically loaded Rust plugins for data integration. Ingest from PostgreSQL, Elasticsearch into Iggy, or forward to MongoDB, Elasticsearch, Apache Iceberg, Quickwit. Built-in data transforms and Prometheus metrics.
...
- **[SDKs](/docs/sdk/introduction)** - client libraries for 7 languages (Rust, Python, Java, Go, Node.js, C#, C++) with examples for each.
