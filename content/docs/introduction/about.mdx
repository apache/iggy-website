...
- Built-in **[benchmarking app](/docs/server/benchmarking)** to test the performance, with published results on the [benchmarks dashboard](https://benchmarks.iggy.apache.org)
