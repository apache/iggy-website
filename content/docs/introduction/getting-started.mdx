...
On Linux the server needs kernel 5.19 or newer. macOS has no kernel requirement. Under WSL2, run `wsl --update` first. See [System requirements](/docs/server/introduction#system-requirements) for the details.
