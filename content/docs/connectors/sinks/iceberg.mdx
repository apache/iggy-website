...
Set `field` to the envelope key that contains the actual row data. See the [transforms documentation](/docs/connectors/transforms) and your source connector's documentation for details on the envelope shape.
