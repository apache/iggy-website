...
Iggy uses [Viewstamped Replication](/docs/0.8/clustering/vsr) to commit partition
...
[Durability](/docs/0.8/server/durability).
...
[Deployment](/docs/0.8/clustering/deploy).
...
durable result. See [Which responses prove completion](/docs/0.8/server/durability#which-responses-prove-completion).
