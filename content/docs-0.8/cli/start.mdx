...
This page covers installing the CLI, connecting to a server, authenticating, and managing connection contexts. The full command tree is documented in the [command reference](/docs/0.8/cli/commands).
...
Once installed, run `iggy` without arguments to print an overview of the available commands, or see the [command reference](/docs/0.8/cli/commands).
