...
Transforms can be applied before writing to InfluxDB. See the [transforms documentation](/docs/0.8/connectors/transforms) for the available types and their configuration.
