...
You can apply transforms before writing to MongoDB. Every `[transforms.*]` section requires `enabled = true`. See the [transforms documentation](/docs/0.8/connectors/transforms) for details.
