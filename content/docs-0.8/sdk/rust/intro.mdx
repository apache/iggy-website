---
title: Intro
description: "The Rust SDK, the primary and most complete Iggy client, and where its source lives."
---
...
See [Connection Strings](/docs/0.8/sdk/connection-strings) for the full per-transport option tables and defaults.
...
For the full getting started tutorial, see [Getting Started](/docs/0.8/introduction/getting-started). For the high-level producer/consumer builders, see [High-level SDK](/docs/0.8/sdk/rust/high-level-sdk) and [Stream Builder](/docs/0.8/sdk/rust/stream-builder).
