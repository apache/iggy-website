---
title: Examples
description: "The Rust SDK examples in the core repository, and how to start a server to run them against."
---
...
- **[Getting started](https://github.com/apache/iggy/tree/master/examples/rust/src/getting-started)** - the basic example which is discussed in the [getting started](/docs/0.8/introduction/getting-started) guide.
...
- **[New SDK](https://github.com/apache/iggy/tree/master/examples/rust/src/new-sdk)** - an introduction to the high-level SDK as discussed in the [dedicated guide](/docs/0.8/sdk/rust/high-level-sdk).
...
- **[Stream builder](https://github.com/apache/iggy/tree/master/examples/rust/src/stream-builder)** - examples using the `IggyStream`, `IggyStreamProducer`, and `IggyStreamConsumer` builder APIs as discussed in the [stream builder guide](/docs/0.8/sdk/rust/stream-builder).
