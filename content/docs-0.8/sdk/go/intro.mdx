...
A runnable getting-started example with producer, consumer, and TLS flags lives in [examples/go](https://github.com/apache/iggy/tree/master/examples/go). See the [examples page](/docs/0.8/sdk/go/examples) for how to run it.
