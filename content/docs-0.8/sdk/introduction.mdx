...
The option keys differ per transport and unknown keys are rejected as **hard errors**. See [Connection Strings](/docs/0.8/sdk/connection-strings) for the full per-transport option tables, defaults, and default ports.
