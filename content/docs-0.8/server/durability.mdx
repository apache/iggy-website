...
[Cluster Durability](/docs/0.8/clustering/durability).
...
These are [topic creation options](/docs/0.8/server/topic-options), not
...
from another replica. See [Storage Engine](/docs/0.8/server/storage-engine).
...
[benchmarking guide](/docs/0.8/server/benchmarking) explains how to reproduce a
workload.
