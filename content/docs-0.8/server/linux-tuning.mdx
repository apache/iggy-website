---
title: Linux tuning
description: "Prepare Linux hosts for Iggy and measure the effects of memory, CPU, storage, and network tuning."
---
...
Use the [benchmarking guide](/docs/0.8/server/benchmarking) to compare throughput, p50, p99 and p99.9 latency, memory use, and errors under the same workload. Keep the server version, transport, topic durability, CPU allocation, and storage identical between runs.
