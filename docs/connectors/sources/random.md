...
Use the broker credentials and runtime setup from the [source guide](/docs/connectors/sources/source#configuration). Save the configuration below in that runtime's connector directory. From the matching 0.9.0/edge repository root, build the plugin:
