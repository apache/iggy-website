...
Use the broker credentials and main runtime configuration from the [source guide](/docs/connectors/sources/source#configuration). From the matching 0.9.0/edge Iggy checkout root, build the plugin:
