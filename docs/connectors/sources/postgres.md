...
Use the broker credentials and main runtime configuration from the [source guide](/docs/connectors/sources/source#configuration). Build the plugin from the matching 0.9.0/edge checkout root:
