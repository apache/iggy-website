...
These examples target server **0.9.0**. Start the server from the same source checkout; see [Getting started](/docs/introduction/getting-started) for prerequisites:
