...
Use an SDK release compatible with your server. For unreleased changes, build both from the same checkout; the [Getting Started](/docs/introduction/getting-started) guide shows the source dependency setup.
