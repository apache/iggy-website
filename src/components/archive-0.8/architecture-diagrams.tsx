...
// Frozen copy of src/components/architecture-diagrams.tsx as it was for the
// Apache Iggy 0.8 docs (commit 9eece0aa), used only by the pages under
// /docs/0.8. Its /docs links point at the 0.8 pages. Do not update it.
...
export function ServerEcosystem() {
  const ring = [
    ...
    { label: "Web UI", sub: "Dashboard", color: "#a855f7", pos: "bottom", href: "/docs/0.8/web_ui/start" },
    { label: "CLI", sub: "Terminal management", color: "#6366f1", pos: "bottom", href: "/docs/0.8/cli/start" },
    { label: "MCP Server", sub: "LLM integration", color: "#ec4899", pos: "bottom", href: "/docs/0.8/ai/mcp" },
    { label: "Connectors", sub: "Sources & Sinks", color: "#14b8a6", pos: "bottom", href: "/docs/0.8/connectors/introduction" },
    { label: "Benchmarks", sub: "iggy-bench", color: "#f97316", pos: "bottom", href: "/docs/0.8/server/benchmarking" },
  ];
  ...
  return (
    <div className="my-8 rounded-xl border border-fd-primary/20 bg-gradient-to-br from-fd-card to-fd-primary/3 p-6">
      <div className="flex items-center justify-between mb-5">
        ...
        <a href="/docs/0.8/introduction/getting-started" className="text-xs text-fd-primary no-underline hover:underline">Full tutorial →</a>
      </div>
...
export function DocsHero() {
  ...
  const links = [
    { title: "Getting Started", href: "/docs/0.8/introduction/getting-started", desc: "Install, configure, send your first messages", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
    { title: "Architecture", href: "/docs/0.8/introduction/architecture", desc: "Thread-per-core, io_uring, shared-nothing design", icon: "M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm0 8a1 1 0 011-1h6a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1v-2zm10 0a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1h-4a1 1 0 01-1-1v-2z" },
    { title: "Connectors", href: "/docs/0.8/connectors/introduction", desc: "Source & sink plugins for data integration", icon: "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" },
    { title: "SDKs", href: "/docs/0.8/sdk/introduction", desc: "Rust, Python, Java, Go, Node.js, C#, C++, PHP", icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" },
    { title: "Server Config", href: "/docs/0.8/server/configuration", desc: "Tune performance, storage, and security", icon: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" },
    { title: "CLI & Web UI", href: "/docs/0.8/cli/start", desc: "Manage streams, topics, users from terminal or browser", icon: "M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
  ];
      ...
      <div className="relative">
        ...
        <div className="rounded-xl border border-fd-border bg-fd-card/60 backdrop-blur p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <a href="/docs/0.8/connectors/introduction" className="text-sm font-semibold text-fd-foreground no-underline hover:text-fd-primary transition-colors">Connectors: Data Integration Pipeline</a>
          </div>

          <div className="flex flex-col md:flex-row items-stretch gap-3">
            <div className="flex-1 rounded-lg border border-emerald-500/20 bg-emerald-500/5 p-3">
              <a href="/docs/0.8/connectors/introduction" className="text-xs font-semibold text-emerald-400 block mb-2 no-underline hover:underline">Sources</a>
              <div className="flex flex-wrap gap-1.5">
                {sources.map((s) => (
            ...
            <a href="/docs/0.8/introduction/architecture" className="flex-1 rounded-lg border-2 border-fd-primary/30 bg-fd-primary/5 p-3 text-center no-underline group hover:border-fd-primary/50 transition-colors">
            ...
            <div className="flex-1 rounded-lg border border-blue-500/20 bg-blue-500/5 p-3">
              <a href="/docs/0.8/connectors/introduction" className="text-xs font-semibold text-blue-400 block mb-2 no-underline hover:underline">Sinks</a>
              <div className="flex flex-wrap gap-1.5">
                {sinks.map((s) => (
                  <span key={s.name} className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-fd-muted/50 text-fd-foreground">
                    <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: s.color }} />
          ...
          <div className="grid grid-cols-2 gap-3 sm:flex sm:justify-center sm:gap-5 mt-4 pt-3 border-t border-fd-border/50">
            {[
              { label: "MCP Server", href: "/docs/0.8/ai/mcp", sub: "40+ LLM tools" },
              { label: "Web UI", href: "/docs/0.8/web_ui/start", sub: "Dashboard" },
              { label: "CLI", href: "/docs/0.8/cli/start", sub: "Terminal" },
              { label: "8 SDKs", href: "/docs/0.8/sdk/introduction", sub: "All languages" },
            ].map((t) => (
